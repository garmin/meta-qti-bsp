...
do_install_append() {
    echo "KDUMP_CMDLINE=\"rcupdate.rcu_expedited=1 rcu_nocbs=0-7 maxcpus=1 root=/dev/ram rw rootwait console=ttyMSM0,115200,n8 lpm_levels.sleep_disabled=1 nokaslr 1 reset_devices androidboot.slot_suffix=_a\"" >> ${D}${sysconfdir}/sysconfig/kdump.conf
